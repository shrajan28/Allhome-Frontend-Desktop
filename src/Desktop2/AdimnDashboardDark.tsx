...
type AdminDashboardDarkProps = {
    title: any;
  };
  
  const AdminDashboardDark: React.FC<AdminDashboardDarkProps> = ({ title }) => {
    return (
        <div className="">
            <AdminHeader title=""/>
            <div className="flex bg-gray-100 ">
                ...
                <div className="grid grid-cols-4  gap-4 mb-6">
                    ...
                    <div
                    className="border text-card-foreground shadow-sm bg-white p-4 rounded-lg flex items-center"
                    data-v0-t="card"
                    >

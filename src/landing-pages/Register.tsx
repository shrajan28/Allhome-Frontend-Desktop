...
const Register: React.FC<RegisterProps> = ({ title }) => {
  return (
    <div className="min-h-screen  bg-[url('C:\Users\shraj\Desktop\bg-image.png')] bg-[#111111A1] bg-contain bg-blend-hue text-white ">
      <Header title="" />
      <main className="py-12">
        <div className="max-w-4xl space-x-16 mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
          <div className="mt-8 ">
            <h2 className="text-4xl font-bold mb-6">
              Alhome - largest Home retail shop in the world.
            </h2>
            <p className="mb-4">
            ...
            <ul className="list-none space-y-2">
              <li className="flex items-center">
                <svg
                  className="w-6 h-6 mr-2 text-sm text-[#FFFFFF] dark:text-white"
                  aria-hidden="true"
                ...
                <div>
                  <form className="space-y-4 mt-4">
                    <div className="flex flex-col">
                      <span className="text-sm mb-2 font-bold text-[#323031]">
                        Name
                      </span>
                      <input
                        type="text"
                    ...
                    <div className="flex flex-col">
                      <span className="text-sm mb-2 font-bold mt- text-[#323031]">
                        Password
                      </span>
                      <input
                        type="password"
                    ...
                    <div>
                      ...
                      >
                        ...
                        />
                        Do you agree to Alhome's Terms of Condition and Privacy
                        Policy.
                      </label>
                    </div>
                  </form>

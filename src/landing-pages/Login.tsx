...
const Login: React.FC<LoginProps> = ({ title }) => {
  return (
    <div className="min-h-screen bg-[#111111A1] bg-contain bg-blend-hue bg-[url('C:\Users\shraj\Desktop\bg-image.png')] text-white ">
      <Header title={""} />
        ...
        <div className="max-w-4xl space-x-16 mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
          <div className="mt-8 ">
            <h2 className="text-4xl font-bold mb-6">
              <FormattedMessage id="app.desLargeFont" />
            </h2>
            <p className="mb-4">
